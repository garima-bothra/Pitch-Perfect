...
extension SoundEditorViewController: AVAudioPlayerDelegate {
    ...
    func setPlayButtonsEnabled(_ enabled: Bool) {
        slowAudioButton.isEnabled = enabled
        lowPitchAudioButton.isEnabled = enabled
        fastAudioButton.isEnabled = enabled
        highPitchAudioButton.isEnabled = enabled
        echoAudioButton.isEnabled = enabled
        reverbAudioButton.isEnabled = enabled
    }
